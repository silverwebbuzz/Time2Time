...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["orders-edit-order-edit-order-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditOrderPageRoutingModule = /** @class */ (function () {
                function EditOrderPageRoutingModule() {
                }
                return EditOrderPageRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditOrderPage = /** @class */ (function () {
                function EditOrderPage(navCtrl, CommonService, router, statusBar, route, modal, storage, formBuilder) {
                    var _this = this;
                    ...
                    this.id = [];
                    this.editorder_fb();
                    this.storage.get(src_config__WEBPACK_IMPORTED_MODULE_7__["USER_DETAILS"]).then(function (res) {
                        if (res) {
                            _this.id = res.userDetails.id;
                        }
                    });
                }
                EditOrderPage.prototype.ionViewWillEnter = function () {
                    this.statusBar.show();
                ...
                EditOrderPage.prototype.removeControls = function (i) {
                    this.productList.splice(i, 1);
                    this.productCalculation();
                };
                EditOrderPage.prototype.changeQty = function (qty, index) {
                    if (qty) {
                ...
                EditOrderPage.prototype.discountApply = function (value) {
                    this.discount = value;
                    var total = 0;
                    ...
                    var tempTotal = Number(this.grossAmount) + Number(this.sCharge) + Number(this.vat);
                    this.netAmount = Number(tempTotal) - Number(value);
                };
                EditOrderPage.prototype.productCalculation = function () {
                    var total = 0;
                    this.productList.forEach(function (e) {
                        total = total + Number(e.amount);
                    });
                ...
                EditOrderPage.prototype.editorder_fb = function () {
                ...
                EditOrderPage.prototype.createItem = function () {
                ...
                EditOrderPage.prototype.getCompanyDetails = function (reqData) {
                    var _this = this;
                    this.CommonService.comGet(reqData).subscribe(function (res) {
                        _this.comdata = res.data;
                        _this.scharge = _this.comdata.service_charge_value;
                        _this.vcharge = _this.comdata.vat_charge_value;
                    });
                };
                EditOrderPage.prototype.orderDetails = function (reqData) {
                    var _this = this;
                    this.CommonService.orderGet(reqData).subscribe(function (res) {
                        _this.orderData = res.data;
                        console.log("::::::", _this.orderData);
                        _this.productList = _this.orderData.order_item;
                        _this.editorder_form.patchValue({
                            customer_name: _this.orderData.customer_name,
                            customer_address: _this.orderData.customer_address,
                            customer_phone: _this.orderData.customer_phone,
                            gross_amount: _this.orderData.gross_amount,
                            discount: _this.orderData.discount,
                            net_amount: _this.orderData.net_amount,
                            paid_status: _this.orderData.paid_status,
                        });
                        _this.productCalculation();
                    }, function (error) {
                    });
                };
                EditOrderPage.prototype.editOrder = function () {
                    var _this = this;
                    for (var v in this.editorder_form.controls) {
                    ...
                    if (this.editorder_form.valid) {
                        ...
                        this.CommonService.orderEdit(body).subscribe(function (val) {
                            _this.order_process = false;
                            _this.CommonService.dismissLoading();
                            if (val.status == 1) {
                                _this.CommonService.dismissLoading();
                                _this.productList = [];
                                _this.CommonService.presentToastWithOptions(val.message);
                                _this.router.navigate(['/manage-orders']);
                            }
                            else {
                                _this.CommonService.presentToastWithOptions(val.message);
                            }
                ...
                EditOrderPage.prototype.addProduct = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    product = _a.sent();
                                    product.onWillDismiss().then(function (data) {
                                        if (data.data) {
                                            ...
                                            _this.productCalculation();
                                            console.log("product_list", _this.productList);
                                        }
                                    });
                                    return [4 /*yield*/, product.present()];
                                case 2: return [2 /*return*/, _a.sent()];
                            }
                        });
                    });
                };
                EditOrderPage.prototype.back = function () {
                    this.navCtrl.pop();
                };
                return EditOrderPage;
            }());
            EditOrderPage.ctorParameters = function () { return [
...
//# sourceMappingURL=orders-edit-order-edit-order-module-es5.js.map
//# sourceMappingURL=orders-edit-order-edit-order-module-es5.js.map