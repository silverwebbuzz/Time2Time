...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["members-manage-members-manage-members-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ManageMembersPageModule = /** @class */ (function () {
                function ManageMembersPageModule() {
                }
                return ManageMembersPageModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ManageMembersPage = /** @class */ (function () {
                function ManageMembersPage(alertCtrl, CommonService, router, platform, statusBar, socialSharing) {
                ...
                ManageMembersPage.prototype.searchBar = function (value) {
                    var searchList = this.member;
                    if (value) {
                ...
                ManageMembersPage.prototype.ionViewWillEnter = function () {
                    var _this = this;
                    this.statusBar.show();
                ...
                ManageMembersPage.prototype.expandItem = function (item) {
                    console.log("item", item);
                    if (item.expanded) {
                        item.expanded = false;
                    }
                    else {
                        this.member.map(function (listItem) {
                            if (item == listItem) {
                ...
                ManageMembersPage.prototype.edit = function (id) {
                    this.router.navigate(['/edit-members'], { queryParams: { id: id } });
                };
                ManageMembersPage.prototype.delete = function (id) {
                                            ...
                                            buttons: [
                                                {
                                                    ...
                                                    text: 'Delete',
                                                    handler: function () {
                                                        _this.CommonService.memberDelete(params)
                                                            .subscribe(function (resp) {
                                                            _this.member = _this.member.filter(function (val) { return val.id !== params; });
                                                        });
                ...
                ManageMembersPage.prototype.loadData = function (infiniteScroll) {
                    var _this = this;
                    setTimeout(function () {
                        _this.limit += 50;
                ...
                ManageMembersPage.prototype.sharePicker = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            this.platform.ready()
            ...
            ManageMembersPage.ctorParameters = function () { return [
...
//# sourceMappingURL=members-manage-members-manage-members-module-es5.js.map
//# sourceMappingURL=members-manage-members-manage-members-module-es5.js.map