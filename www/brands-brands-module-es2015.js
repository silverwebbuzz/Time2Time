...
let BrandsPage = class BrandsPage {
    constructor(alertCtrl, CommonService, router, platform, socialSharing, statusBar, 
    // private file: File,
    storage) {
    ...
    checkToken() {
        return this.storage.get(src_config__WEBPACK_IMPORTED_MODULE_14__["USER_DETAILS"]).then(res => {
            if (res) {
