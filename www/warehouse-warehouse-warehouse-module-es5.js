...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["warehouse-warehouse-warehouse-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WarehousePageModule = /** @class */ (function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WarehousePage = /** @class */ (function () {
                function WarehousePage(alertCtrl, CommonService, router, statusBar, platform, storage, socialSharing) {
                ...
                WarehousePage.prototype.checkToken = function () {
                    var _this = this;
                    return this.storage.get(src_config__WEBPACK_IMPORTED_MODULE_10__["USER_DETAILS"]).then(function (res) {
                        if (res) {
                ...
                WarehousePage.prototype.isActive = function (val) {
                    if (val == 1) {
                        return 'Active';
                    }
                    else {
                ...
                WarehousePage.prototype.searchBar = function (value) {
                    var searchList = this.warehouse;
                    if (value) {
                ...
                WarehousePage.prototype.ionViewWillEnter = function () {
                    var _this = this;
                    this.statusBar.show();
                    ...
                    this.CommonService.warehouseList()
                        ...
                        console.log(_this.warehouse);
                        _this.CommonService.dismissLoading();
                    });
                };
                WarehousePage.prototype.loadData = function (infiniteScroll) {
                    var _this = this;
                    setTimeout(function () {
                        _this.limit += 50;
                ...
                WarehousePage.prototype.edit = function (id) {
                    this.router.navigate(['/edit-warehouse'], { queryParams: { id: id } });
                };
                WarehousePage.prototype.warehouseProducts = function (warehouseid) {
                    console.log("Warehouse ID", warehouseid);
                    this.router.navigate(['/warehouse-product'], { queryParams: { warehouseid: warehouseid } });
                };
                WarehousePage.prototype.delete = function (id) {
                                            ...
                                            buttons: [
                                                {
                                                    ...
                                                    text: 'Delete',
                                                    handler: function () {
                                                        _this.CommonService.warehouseDelete(params)
                                                            .subscribe(function (resp) {
                                                            _this.warehouse = _this.warehouse.filter(function (val) { return val.id !== params; });
                                                        });
                ...
                WarehousePage.prototype.sharePicker = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            this.platform.ready()
...
//# sourceMappingURL=warehouse-warehouse-warehouse-module-es5.js.map
//# sourceMappingURL=warehouse-warehouse-warehouse-module-es5.js.map