...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["stock-report-stock-report-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StockReportPageModule = /** @class */ (function () {
                function StockReportPageModule() {
                }
                return StockReportPageModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StockReportPage = /** @class */ (function () {
                function StockReportPage(CommonService, platform, statusBar, socialSharing) {
                ...
                StockReportPage.prototype.Availability = function (val) {
                    if (val == 1) {
                        return 'Yes';
                    }
                    else {
                ...
                StockReportPage.prototype.ngOnInit = function () {
                };
                StockReportPage.prototype.expandItem = function (item) {
                    console.log("item", item);
                    if (item.expanded) {
                        item.expanded = false;
                    }
                    else {
                        this.stock.map(function (listItem) {
                            if (item == listItem) {
                ...
                StockReportPage.prototype.searchBar = function (value) {
                    var searchList = this.stock;
                ...
                StockReportPage.prototype.ionViewWillEnter = function () {
                    var _this = this;
                    this.statusBar.show();
                    ...
                    this.CommonService.stocklist()
                        ...
                        _this.resp = resp;
                        _this.stock = resp.data;
                        console.log(_this.stock);
                        _this.CommonService.dismissLoading();
                    });
                };
                StockReportPage.prototype.loadData = function (infiniteScroll) {
                    var _this = this;
                    setTimeout(function () {
                        _this.limit += 50;
                ...
                StockReportPage.prototype.sharePicker = function () {
            ...
            StockReportPage.ctorParameters = function () { return [
...
//# sourceMappingURL=stock-report-stock-report-module-es5.js.map
//# sourceMappingURL=stock-report-stock-report-module-es5.js.map