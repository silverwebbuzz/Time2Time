(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["warehouse-edit-warehouse-edit-warehouse-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditWarehousePageRoutingModule = /** @class */ (function () {
                function EditWarehousePageRoutingModule() {
                }
                return EditWarehousePageRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditWarehousePageModule = /** @class */ (function () {
                function EditWarehousePageModule() {
                }
                return EditWarehousePageModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditWarehousePage = /** @class */ (function () {
                function EditWarehousePage(navCtrl, formBuilder, CommonService, router, statusBar, route) {
                ...
                EditWarehousePage.prototype.ionViewWillEnter = function () {
                    this.statusBar.show();
                    this.statusBar.styleLightContent();
                    this.statusBar.backgroundColorByHexString('#6382ff');
                };
                EditWarehousePage.prototype.isActive = function (val) {
                    if (val == 1) {
                        return 'Active';
                    }
                    else {
                ...
                EditWarehousePage.prototype.ngOnInit = function () {
                    var reqData = this.route.snapshot.queryParams;
                    this.warehouseDetails(reqData);
                };
                EditWarehousePage.prototype.edtwarehouse_fb = function () {
                ...
                EditWarehousePage.prototype.warehouseDetails = function (reqData) {
                    var _this = this;
                    this.CommonService.warehouseGet(reqData).subscribe(function (res) {
                        _this.warehouseData = res.data;
                        console.log("::::::", _this.warehouseData);
                        _this.editwarehouse_form.patchValue({
                            name: _this.warehouseData.name,
                            active: _this.warehouseData.active
                        });
                    }, function (error) {
                    });
                };
                EditWarehousePage.prototype.editWarehouse = function () {
                    var _this = this;
                    for (var v in this.editwarehouse_form.controls) {
                    ...
                    if (this.editwarehouse_form.valid) {
                        ...
                        this.CommonService.warehouseEdit(body).subscribe(function (val) {
                ...
                EditWarehousePage.prototype.back = function () {
                    this.navCtrl.pop();
                };
                return EditWarehousePage;
            }());
            EditWarehousePage.ctorParameters = function () { return [
...
//# sourceMappingURL=warehouse-edit-warehouse-edit-warehouse-module-es5.js.map
//# sourceMappingURL=warehouse-edit-warehouse-edit-warehouse-module-es5.js.map