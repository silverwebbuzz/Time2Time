(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["warehouse-warehouse-product-warehouse-product-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WarehouseProductPageRoutingModule = /** @class */ (function () {
                function WarehouseProductPageRoutingModule() {
                }
                return WarehouseProductPageRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WarehouseProductPageModule = /** @class */ (function () {
                function WarehouseProductPageModule() {
                }
                return WarehouseProductPageModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WarehouseProductPage = /** @class */ (function () {
                function WarehouseProductPage(navCtrl, CommonService, router, statusBar, route) {
                    var _this = this;
                    ...
                    this.route.queryParams.subscribe(function (params) {
                        ...
                        _this.warehouseid = params.warehouseid;
                    });
                }
                WarehouseProductPage.prototype.ngOnInit = function () {
                };
                WarehouseProductPage.prototype.back = function () {
                    console.log('back');
                    this.navCtrl.pop();
                };
                WarehouseProductPage.prototype.expandItem = function (item) {
                    console.log("item", item);
                    if (item.expanded) {
                        item.expanded = false;
                    }
                    else {
                        this.warehouseProd.map(function (listItem) {
                            if (item == listItem) {
                ...
                WarehouseProductPage.prototype.searchBar = function (value) {
                    console.log("value", value);
                    var searchList = this.warehouseProd;
                    if (value) {
                ...
                WarehouseProductPage.prototype.ionViewWillEnter = function () {
                    var _this = this;
                    this.statusBar.show();
                    ...
                    this.CommonService.warehouseProducts(this.warehouseid)
                        ...
                        _this.resp = resp;
                        _this.warehouseProd = resp.data;
                        console.log("brandProd", _this.warehouseProd);
                        _this.CommonService.dismissLoading();
                    });
                };
                WarehouseProductPage.prototype.isActive = function (val) {
                    if (val == 1) {
                        return 'Active';
                    }
                    else {
                ...
                WarehouseProductPage.prototype.loadData = function (infiniteScroll) {
                    var _this = this;
                    setTimeout(function () {
                        _this.limit += 50;
            ...
            WarehouseProductPage.ctorParameters = function () { return [
...
//# sourceMappingURL=warehouse-warehouse-product-warehouse-product-module-es5.js.map
//# sourceMappingURL=warehouse-warehouse-product-warehouse-product-module-es5.js.map