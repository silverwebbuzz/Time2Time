(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginPage = /** @class */ (function () {
                function LoginPage(navCtrl, statusBar, router, menu, formBuilder, service, auth) {
                ...
                LoginPage.prototype.doLogin = function () {
                    ...
                    if (this.login_form.valid) {
                        ...
                        this.auth.login(body).subscribe(function (val) {
                            _this.login_process = false;
                            _this.service.dismissLoading();
                            if (val.status) {
                                _this.auth.loginAuth(val).then(function () {
                                    _this.service.presentToastWithOptions(val.message);
                            ...
                            _this.login_process = false;
                            _this.service.dismissLoading();
                            _this.service.presentToastWithOptions("Internal Server Error Please try again after sometime.");
                        });
                    }
                };
                return LoginPage;
