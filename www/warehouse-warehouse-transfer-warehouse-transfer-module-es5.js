...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["warehouse-warehouse-transfer-warehouse-transfer-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WarehouseTransferPageModule = /** @class */ (function () {
                function WarehouseTransferPageModule() {
                }
                return WarehouseTransferPageModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WarehouseTransferPage = /** @class */ (function () {
                function WarehouseTransferPage(router, CommonService, platform, statusBar, storage, socialSharing) {
                    this.router = router;
                ...
                WarehouseTransferPage.prototype.expandItem = function (item) {
                    console.log("item", item);
                    if (item.expanded) {
                        item.expanded = false;
                    }
                    else {
                        this.transfer.map(function (listItem) {
                            if (item == listItem) {
                ...
                WarehouseTransferPage.prototype.isActive = function (val) {
                    if (val == 1) {
                        return 'Active';
                    }
                    else {
                ...
                WarehouseTransferPage.prototype.searchBar = function (value) {
                    var searchList = this.transfer;
                    if (value) {
                ...
                WarehouseTransferPage.prototype.ionViewWillEnter = function () {
                    var _this = this;
                    this.statusBar.show();
                    ...
                    this.CommonService.ware_Transfer_list()
                        ...
                        _this.resp = resp;
                        _this.transfer = resp.data;
                        console.log(_this.transfer);
                        _this.CommonService.dismissLoading();
                    });
                };
                WarehouseTransferPage.prototype.checkToken = function () {
                    var _this = this;
                    return this.storage.get(src_config__WEBPACK_IMPORTED_MODULE_12__["USER_DETAILS"]).then(function (res) {
                        if (res) {
                ...
                WarehouseTransferPage.prototype.loadData = function (infiniteScroll) {
                    var _this = this;
                    setTimeout(function () {
                        _this.limit += 50;
                ...
                WarehouseTransferPage.prototype.edit = function (id) {
                    console.log("idddd", id);
                    this.router.navigate(['/edit-product'], { queryParams: { id: id } });
                };
                WarehouseTransferPage.prototype.sharePicker = function () {
            ...
            WarehouseTransferPage.ctorParameters = function () { return [
...
//# sourceMappingURL=warehouse-warehouse-transfer-warehouse-transfer-module-es5.js.map
//# sourceMappingURL=warehouse-warehouse-transfer-warehouse-transfer-module-es5.js.map