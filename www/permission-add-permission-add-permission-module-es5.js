(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["permission-add-permission-add-permission-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddPermissionPage = /** @class */ (function () {
                function AddPermissionPage(navCtrl, CommonService, router, statusBar, formBuilder) {
                ...
                AddPermissionPage.prototype.ionViewWillEnter = function () {
                    this.statusBar.show();
                ...
                AddPermissionPage.prototype.isAllSelected = function () {
                    this.masterSelected = this.checklist.every(function (item) {
                        return item.isSelected == true;
                    });
                    this.getCheckedItemList();
                };
                AddPermissionPage.prototype.getCheckedItemList = function () {
                    this.checkedList = [];
                ...
                AddPermissionPage.prototype.addpermission_fb = function () {
                ...
                AddPermissionPage.prototype.addPermission = function () {
                    var _this = this;
                    for (var v in this.addpermission_form.controls) {
                    ...
                    if (this.addpermission_form.valid) {
                        ...
                        this.CommonService.permissionAdd(body).subscribe(function (val) {
            ...
            AddPermissionPage.ctorParameters = function () { return [
...
//# sourceMappingURL=permission-add-permission-add-permission-module-es5.js.map
//# sourceMappingURL=permission-add-permission-add-permission-module-es5.js.map