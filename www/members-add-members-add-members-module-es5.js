(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["members-add-members-add-members-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddMembersPage = /** @class */ (function () {
                function AddMembersPage(navCtrl, CommonService, router, statusBar, formBuilder) {
                ...
                AddMembersPage.prototype.ionViewWillEnter = function () {
                    this.statusBar.show();
                ...
                AddMembersPage.prototype.addmembers_fb = function () {
                ...
                ;
                AddMembersPage.prototype.permissionList = function () {
                    var _this = this;
                    this.CommonService.getPermisssionList().subscribe(function (data) {
                        _this.permissionlist = data.data;
                        console.log("per::", _this.permissionlist);
                    });
                };
                AddMembersPage.prototype.addMember = function () {
                    var _this = this;
                    for (var v in this.addmembers_form.controls) {
                    ...
                    if (this.addmembers_form.valid) {
                        ...
                        this.CommonService.memberAdd(body).subscribe(function (val) {
...
//# sourceMappingURL=members-add-members-add-members-module-es5.js.map
//# sourceMappingURL=members-add-members-add-members-module-es5.js.map