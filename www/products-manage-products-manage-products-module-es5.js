...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["products-manage-products-manage-products-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ManageProductsPageModule = /** @class */ (function () {
                function ManageProductsPageModule() {
                }
                return ManageProductsPageModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ManageProductsPage = /** @class */ (function () {
                function ManageProductsPage(modal, alertCtrl, CommonService, router, statusBar, platform, storage, socialSharing, menu) {
                    this.modal = modal;
                ...
                ManageProductsPage.prototype.expandItem = function (item) {
                    if (item.expanded) {
                        item.expanded = false;
                    }
                    else {
                        this.product.map(function (listItem) {
                            if (item == listItem) {
                ...
                ManageProductsPage.prototype.checkToken = function () {
                    var _this = this;
                    return this.storage.get(src_config__WEBPACK_IMPORTED_MODULE_13__["USER_DETAILS"]).then(function (res) {
                        if (res) {
                            _this.permission = res.userPermission.group_name;
                        }
                    });
                };
                ManageProductsPage.prototype.ngOnInit = function () {
                };
                ManageProductsPage.prototype.filter = function () {
                            ...
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    filterModal.onDidDismiss()
                                        ...
                                        _this.setFilterData = optdata.data;
                                        var searchList = _this.resp.data;
                                        var searchkeyValue = document.getElementById('searchValue').value;
                                        if (searchkeyValue) {
                ...
                ManageProductsPage.prototype.Availability = function (val) {
                    if (val == 1) {
                        return 'Yes';
                    }
                    else {
                ...
                ManageProductsPage.prototype.addProduct = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var product;
                        var _this = this;
                        return __generator(this, function (_a) {
                ...
                ManageProductsPage.prototype.searchBar = function (value) {
                    var searchList = this.product;
                    if (value) {
                        searchList = lodash__WEBPACK_IMPORTED_MODULE_12__["filter"](searchList, function (x) {
                ...
                ManageProductsPage.prototype.ionViewWillEnter = function () {
                    var _this = this;
                ...
                ManageProductsPage.prototype.edit = function (id) {
                    this.router.navigate(['/edit-product'], { queryParams: { id: id } });
                };
                ManageProductsPage.prototype.loadData = function (infiniteScroll) {
                    var _this = this;
                    setTimeout(function () {
                        _this.limit += 50;
                ...
                ManageProductsPage.prototype.delete = function (id) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var params, alert;
                        var _this = this;
                        return __generator(this, function (_a) {
                                            ...
                                            buttons: [
                                                {
                                                    ...
                                                    text: 'Delete',
                                                    handler: function () {
                                                        _this.CommonService.productDelete(params)
                                                            .subscribe(function (resp) {
                                                            _this.product = _this.product.filter(function (val) { return val.id !== params; });
                                                        });
                                                    }
                                                }
                                            ]
                ...
                ManageProductsPage.prototype.sharePicker = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var doc, col, rows;
                        var _this = this;
                        return __generator(this, function (_a) {
                            doc = new jspdf__WEBPACK_IMPORTED_MODULE_14__();
                            col = ["Brand", "Refrence Number", "Serial", "Currency", "Price", "Status", "Warehouse"];
                            rows = [];
                            this.product.forEach(function (data) {
            ...
            ManageProductsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=products-manage-products-manage-products-module-es5.js.map
//# sourceMappingURL=products-manage-products-manage-products-module-es5.js.map