(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["search-search-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchPage = /** @class */ (function () {
                function SearchPage(CommonService) {
                    this.CommonService = CommonService;
                    this.limit = 50;
                }
                SearchPage.prototype.ngOnInit = function () {
                };
                SearchPage.prototype.ionViewWillEnter = function (search) {
                    var _this = this;
                    if (!search) {
                    ...
                    this.CommonService.searchlist()
                        ...
                        _this.total = resp.total_products_inventory;
                        _this.sold = resp.total_products_sold;
                        _this.search = resp.data;
                        console.log("this.search", _this.search);
                        if (search && search.trim() != '') {
                            _this.search = _this.search.filter(function (item) {
                ...
                SearchPage.prototype.loadData = function (infiniteScroll) {
                    var _this = this;
                    setTimeout(function () {
                        _this.limit += 50;
