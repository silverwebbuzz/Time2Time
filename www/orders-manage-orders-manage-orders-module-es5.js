...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["orders-manage-orders-manage-orders-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ManageOrdersPageModule = /** @class */ (function () {
                function ManageOrdersPageModule() {
                }
                return ManageOrdersPageModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ManageOrdersPage = /** @class */ (function () {
                function ManageOrdersPage(alertCtrl, CommonService, router, platform, statusBar, storage, socialSharing) {
                ...
                ManageOrdersPage.prototype.ngOnInit = function () {
                };
                ManageOrdersPage.prototype.checkToken = function () {
                    var _this = this;
                    return this.storage.get(src_config__WEBPACK_IMPORTED_MODULE_9__["USER_DETAILS"]).then(function (res) {
                        if (res) {
                ...
                ManageOrdersPage.prototype.searchBar = function (value) {
                    var searchList = this.order;
                    if (value) {
                ...
                ManageOrdersPage.prototype.ionViewWillEnter = function () {
                    var _this = this;
                    this.statusBar.show();
                    ...
                    this.CommonService.orderList()
                        ...
                        _this.resp = resp;
                        _this.order = resp.orderList;
                        console.log(_this.order);
                        _this.CommonService.dismissLoading();
                    });
                };
                ManageOrdersPage.prototype.expandItem = function (item) {
                    if (item.expanded) {
                        item.expanded = false;
                    }
                    else {
                        this.order.map(function (listItem) {
                            if (item == listItem) {
                ...
                ManageOrdersPage.prototype.edit = function (id) {
                    this.router.navigate(['/edit-order'], { queryParams: { id: id } });
                };
                ManageOrdersPage.prototype.loadData = function (infiniteScroll) {
                    var _this = this;
                    setTimeout(function () {
                        _this.limit += 50;
                ...
                ManageOrdersPage.prototype.delete = function (id) {
                                            ...
                                            buttons: [
                                                {
                                                    ...
                                                    text: 'Delete',
                                                    handler: function () {
                                                        _this.CommonService.orderDelete(params)
                                                            .subscribe(function (resp) {
                                                            _this.order = _this.order.filter(function (val) { return val.id !== params; });
                                                        });
                ...
                ManageOrdersPage.prototype.sharePicker = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _this = this;
                        return __generator(this, function (_a) {
                            this.platform.ready()
            ...
            ManageOrdersPage.ctorParameters = function () { return [
...
//# sourceMappingURL=orders-manage-orders-manage-orders-module-es5.js.map
//# sourceMappingURL=orders-manage-orders-manage-orders-module-es5.js.map