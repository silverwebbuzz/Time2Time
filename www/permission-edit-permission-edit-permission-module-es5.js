(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["permission-edit-permission-edit-permission-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditPermissionPageRoutingModule = /** @class */ (function () {
                function EditPermissionPageRoutingModule() {
                }
                return EditPermissionPageRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditPermissionPageModule = /** @class */ (function () {
                function EditPermissionPageModule() {
                }
                return EditPermissionPageModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditPermissionPage = /** @class */ (function () {
                function EditPermissionPage(navCtrl, CommonService, router, statusBar, route, formBuilder) {
                ...
                EditPermissionPage.prototype.ionViewWillEnter = function () {
                    this.statusBar.show();
                    this.statusBar.styleLightContent();
                    this.statusBar.backgroundColorByHexString('#6382ff');
                };
                EditPermissionPage.prototype.ngOnInit = function () {
                    var reqData = this.route.snapshot.queryParams;
                    this.permissionDetails(reqData);
                };
                EditPermissionPage.prototype.permissionDetails = function (reqData) {
                    var _this = this;
                    var newarray = [];
                    this.CommonService.permissionGet(reqData).subscribe(function (res) {
                        console.log("Data", res);
                        _this.permissiondetails = res.data;
                        _this.permissionArrydata = res.unserialize_permission;
                        var categorydata = _this.permissionArrydata;
                        for (var j in categorydata) {
                            newarray.push(categorydata[j]);
                        }
                        _this.selectedcategory = newarray;
                        _this.checklist.map(function (x) {
                        ...
                        _this.editpermission_form.patchValue({
                            group_name: _this.permissiondetails.group_name,
                        });
                    });
                };
                EditPermissionPage.prototype.editpermission_fb = function () {
                ...
                EditPermissionPage.prototype.editPermission = function () {
                    var _this = this;
                    var finalResult = lodash__WEBPACK_IMPORTED_MODULE_7__["filter"](this.checklist, function (x) {
                        return x.isSelected == true;
                    });
                    console.log("finalResult", finalResult);
                    for (var v in this.editpermission_form.controls) {
                    ...
                    if (this.editpermission_form.valid) {
                        ...
                        this.CommonService.permissionEdit(body).subscribe(function (val) {
                            console.log("+++++++++", val);
                            _this.permission_process = false;
                            _this.CommonService.dismissLoading();
                            if (val.status == 1) {
                                _this.CommonService.dismissLoading();
                                _this.CommonService.presentToastWithOptions(val.message);
                                _this.router.navigate(['/manage-permission']);
                            }
                            else {
                                _this.CommonService.presentToastWithOptions(val.message);
                            }
                ...
                EditPermissionPage.prototype.isAllSelected = function (value, values) {
                ...
                EditPermissionPage.prototype.getCheckedItemList = function () {
                    this.checkedList = [];
                ...
                EditPermissionPage.prototype.back = function () {
                    this.navCtrl.pop();
                };
                return EditPermissionPage;
            }());
            EditPermissionPage.ctorParameters = function () { return [
...
//# sourceMappingURL=permission-edit-permission-edit-permission-module-es5.js.map
//# sourceMappingURL=permission-edit-permission-edit-permission-module-es5.js.map