(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["products-add-product-add-product-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddProductPage = /** @class */ (function () {
                function AddProductPage(navCtrl, CommonService, router, statusBar, formBuilder) {
                ...
                AddProductPage.prototype.itemList = function () {
                    var _this = this;
                    var newArray = [];
                ...
                AddProductPage.prototype.categoryList = function () {
                    var _this = this;
                    var newArray = [];
                ...
                AddProductPage.prototype.warehouseList = function () {
                    var _this = this;
                    this.CommonService.warehouselist().subscribe(function (data) {
                        _this.warehouselist = data.data;
                    });
                };
                AddProductPage.prototype.addproduct_fb = function () {
                ...
                AddProductPage.prototype.addProduct = function () {
                    var _this = this;
                    for (var v in this.addproduct_form.controls) {
                    ...
                    if (this.addproduct_form.valid) {
                        ...
                        this.CommonService.productAdd(body).subscribe(function (val) {
                ...
                AddProductPage.prototype.imageUpload = function (e) {
                    var _this = this;
                    console.log("eeee", e);
                    ...
                    if (file) {
                        ...
                        reader.onloadend = function (e) {
                            _this.imagePriview = e.target.result;
                            console.log(" this.imagePriview", _this.imagePriview);
                        };
            ...
            AddProductPage.ctorParameters = function () { return [
...
//# sourceMappingURL=products-add-product-add-product-module-es5.js.map
//# sourceMappingURL=products-add-product-add-product-module-es5.js.map