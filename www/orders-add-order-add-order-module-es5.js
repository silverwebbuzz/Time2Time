...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["orders-add-order-add-order-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddOrderPage = /** @class */ (function () {
                function AddOrderPage(navCtrl, CommonService, router, statusBar, route, formBuilder, product, modal, storage) {
                    var _this = this;
                ...
                AddOrderPage.prototype.removeControls = function (i) {
                    this.productList.splice(i, 1);
                    this.productCalculation();
                };
                AddOrderPage.prototype.changeQty = function (qty, index) {
                    if (qty) {
                ...
                AddOrderPage.prototype.discountApply = function (value) {
                    this.discount = value;
                    var total = 0;
                ...
                AddOrderPage.prototype.productCalculation = function () {
                    var total = 0;
                    this.productList.forEach(function (e) {
                        total = total + Number(e.amount);
                    });
                ...
                AddOrderPage.prototype.expandItem = function (item) {
                    //console.log("item",item);
                    if (item.expanded) {
                        item.expanded = false;
                    }
                    else {
                        this.productList.map(function (listItem) {
                            if (item == listItem) {
                ...
                AddOrderPage.prototype.addorder_fb = function () {
                ...
                AddOrderPage.prototype.createItem = function () {
                ...
                AddOrderPage.prototype.getCompanyDetails = function (reqData) {
                    var _this = this;
                ...
                AddOrderPage.prototype.addOrder = function () {
                    ...
                    for (var v in this.addorder_form.controls) {
                    ...
                    if (this.addorder_form.valid) {
                        ...
                        this.CommonService.orderAdd(body).subscribe(function (val) {
                ...
                AddOrderPage.prototype.addProduct = function () {
            ...
            AddOrderPage.ctorParameters = function () { return [
...
//# sourceMappingURL=orders-add-order-add-order-module-es5.js.map
//# sourceMappingURL=orders-add-order-add-order-module-es5.js.map